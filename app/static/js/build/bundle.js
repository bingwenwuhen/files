...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Files, null), document.getElementById("todo-container"));
	        ...
	        return(
	            React.createElement("form", {className: "input-group", onSubmit: this.handleSubmit}, 
	                ...
	                React.createElement("span", {className: "input-group-btn"}, 
	                    React.createElement("button", {className: "btn btn-default", type: "submit"}, "Select")
	                )
	            )
	        )
	    }
